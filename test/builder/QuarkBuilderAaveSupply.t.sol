...
contract QuarkBuilderAaveSupplyTest is Test, QuarkBuilderTest {
    ...
    ) internal pure returns (QuarkBuilderBase.AaveSupplyIntent memory) {
        return QuarkBuilderBase.AaveSupplyIntent({
            amount: amount,
    ...
    function testAaveSupplyMaxCostTooHigh() public {
        QuarkBuilder builder = new QuarkBuilder();
