            ...
            test: .init(
                ...
                expect: .success(
                    .multi([
                        ...
                        .transferErc20(
                            tokenAmount: .amt(98, .usdc), recipient: .bob, network: .arbitrum),
                    ])
                )
            )
        )
            ...
            test: .init(
                ...
                expect: .success(
                    .multi([
                        ...
                        .transferErc20(
                            tokenAmount: .amt(50, .usdc), recipient: .bob, network: .arbitrum),
                        .quotePay(payment: .amt(0.06, .usdc), payee: .stax, quote: .basic),
                    ])
                )
            )
            ...
            test: .init(
                ...
                expect: .success(
                    .multi([
                        ...
                        .transferErc20(
                            tokenAmount: .amt(50.1, .usdc), recipient: .bob, network: .arbitrum),
                    ])
                )
            )
        )
